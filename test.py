...
'''
Небольшой модуль тестирования. Проверяет что работают все ключи, работает соединение клиент-сервер и функционал команд
'''
...
Разобрал 7 тест кейсов.
1 - поиск сигнатуры по паттерну
2 - поиск сигнатуры по паттерну, но паттерн не верен
3 - поиск сигнатуры по паттерну, но паттерн не передан
4 - поиск сигнатуры по паттерну, но файл неверен
5 - помещение файла в карантин
6 - помещение файла в карантин, но паттерн не убран
7 - помещение файла в карантин, но файл неверен
'''
test_requests=[['CheckLocalFile','dummy.bin','02','2,12'],
               ['CheckLocalFile','dummy.bin','cc','signature not found'],
...
#фикстура под передачу параметров
